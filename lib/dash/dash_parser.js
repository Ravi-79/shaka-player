  ...
  async processManifest_(mpd, finalManifestUri) {
    ...
    if (!this.manifest_) {
      ...
      if (textStreams.length > 0) {
        const aiCaptionTextStreams = this.manifest_.textStreams
            .filter((textStream) => textStream.groupId == 'ai-Caption');
        this.manifest_.textStreams = textStreams;
        this.manifest_.textStreams = this.manifest_.textStreams
            .concat(aiCaptionTextStreams);
      }
    ...
    for (const prop of accessibilities) {
      ...
      if (schemeId == 'urn:scte:dash:cc:cea-608:2015' ) {
        ...
        if (value != null) {
          ...
          const CEA608_MIME = shaka.util.MimeUtils
              .CEA608_CLOSED_CAPTION_MIMETYPE;
          closedCaptions.set('CC1', CEA608_MIME);
        }
        ...
        if (value != null) {
          ...
          const CEA708_MIME = shaka.util.MimeUtils
              .CEA708_CLOSED_CAPTION_MIMETYPE;
          closedCaptions.set('svc1', CEA708_MIME);
        }
