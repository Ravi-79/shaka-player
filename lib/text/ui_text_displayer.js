...
shaka.text.UITextDisplayer = class {
  ...
  append(cues) {
    ...
    for (const cue of cues) {
      ...
      //const interval  = 1;
      const extraCue1 = new shaka.text.Cue(cue.startTime, cue.endTime, "This");
      // const extraCue2 = new shaka.text.Cue(extraCue1.endTime, extraCue1.endTime+interval, 'This is');
      // const extraCue3 = new shaka.text.Cue(extraCue2.endTime, extraCue2.endTime+interval, 'This is additional');
      // const extraCue4 = new shaka.text.Cue(extraCue3.endTime, extraCue3.endTime+interval, 'This is additional text');
       console.log(cue);
      console.log(extraCue1);
      // console.log(extraCue2);
      // console.log(extraCue3);
      // console.log(extraCue4);
      if (!containsCue) {
        this.cues_.push(extraCue1);
        // this.cues_.push(extraCue2);
        // this.cues_.push(extraCue3);
        // this.cues_.push(extraCue4);
      }
    }
